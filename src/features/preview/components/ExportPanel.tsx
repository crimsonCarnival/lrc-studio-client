...
interface ExportPanelProps {
  ...
  setIncludeTranslations: (v: boolean) => void;
  includeSecondary: boolean;
  setIncludeSecondary: (v: boolean) => void;
  includeWordTimestamps: boolean;
  setIncludeWordTimestamps: (v: boolean) => void;
  ...
  useEffect(() => {
    ...
    const handler = (e: MouseEvent) => {
      ...
      if (
        ...
        !target.closest('[data-export-toggle]')
      ) {
            ...
            {(hasSecondary || hasFurigana) && (
              <div className="flex items-center gap-2">
                <Checkbox
                  ...
                  onCheckedChange={(c) => setIncludeSecondary(c === true)}
                  className="border-zinc-600 bg-zinc-900 data-[state=checked]:bg-primary data-[state=checked]:border-primary"
                />
            ...
            {hasTranslations && (
              <div className="flex items-center gap-2">
                <Checkbox
                  ...
                  onCheckedChange={(c) => setIncludeTranslations(c === true)}
                  className="border-zinc-600 bg-zinc-900 data-[state=checked]:bg-primary data-[state=checked]:border-primary"
                />
            ...
            {hasWords && (
              <div className="flex items-center gap-2">
                <Checkbox
                  ...
                  onCheckedChange={(c) => setIncludeWordTimestamps(c === true)}
                  className="border-zinc-600 bg-zinc-900 data-[state=checked]:bg-primary data-[state=checked]:border-primary"
                />
