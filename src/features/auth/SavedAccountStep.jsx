...
export default function SavedAccountStep({ t, savedAccounts, accountsChecked, onProceedToPassword, onGoogleLogin, onAddAccount, onRemoveAccount, onPasskeySuccess }) {
