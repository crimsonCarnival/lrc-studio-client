...
export function GoogleButton({ onClick, t }) {
  return (
    <button
      type="button"
      onClick={onClick}
      className="w-full h-11 bg-[#09090b] hover:bg-zinc-800 text-white font-bold text-sm rounded-xl flex items-center justify-center gap-3 transition-all duration-200 shadow-md hover:shadow-lg border border-zinc-800/50"
    >
