...
import { Ban, CheckCircle2, XCircle, Clock, MessageSquareQuote } from 'lucide-react';

export default function AppealDetailsModal({ isOpen, user, onApprove, onReject, onCancel }) {
