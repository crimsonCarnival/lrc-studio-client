...
function saturate([r, g, b], factor) {
...
export function useColorPalette(imageUrl) {
  ...
  const [asyncResult, setAsyncResult] = useState(/** @type {{ url: string, palette: any } | null} */ (null));
  const cancelRef = useRef(/** @type {boolean} */ (false));
