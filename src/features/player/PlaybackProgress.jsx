  ...
  return (
    <div className="w-full flex flex-col gap-0 mt-2 animate-fade-in">
      ...
      >
        ...
        <div
          className="absolute h-full bg-primary/10 transition-all duration-100 ease-linear border-r border-primary/30"
        ...
        <div
          className="absolute top-0 bottom-0 w-0.5 -translate-x-1/2 pointer-events-none z-30 transition-[left] duration-100 ease-linear"
