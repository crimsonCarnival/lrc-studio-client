...
/** Maps Spotify genre strings to PRIMARY_GENRES enum keys */
export const SPOTIFY_GENRE_MAP: [PrimaryGenre, string[]][] = [
...
export function matchSpotifyGenre(genres: string[]): PrimaryGenre | '' {
