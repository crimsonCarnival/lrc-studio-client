 ...
 */
export function TimestampBadge({ value, isSynced, isFocused, isActive, precision, onClick, onDoubleClick, onWheel, nudgeIndicator }: TimestampBadgeProps) {
  return (
    <div className="relative inline-flex items-center">
      ...
      >
        {isSynced ? formatTimestamp(value ?? 0, precision) : '--:--.--'}
      </button>
      {nudgeIndicator && (
