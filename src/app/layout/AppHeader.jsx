...
export function AppHeader({
  ...
  const searchOverlayRef = useRef(/** @type {HTMLDivElement | null} */(null));
  const projectNameInputRef = useRef(/** @type {HTMLInputElement | null} */(null));
