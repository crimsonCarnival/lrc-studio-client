export default {
  ...
  loginSubtitle: "Ingresa tu identificador o correo para continuar.",
  ...
  username: "Usuario",
  accountName: "Identificador (opcional)",
  displayName: "Nombre visible",
  handleOrEmail: "Identificador o correo",
  accountNameHint: "Usado en URLs y menciones. Minúsculas, 3–30 caracteres.",
  accountNamePlaceholder: "identificador (opcional)",
  ...
  validation: {
    ...
    accountNamePattern: "El identificador debe tener 3–30 caracteres: minúsculas, números, _ o -",
    identifierInvalid: "Ingresa un correo válido o un identificador (ej. @tuidentificador)",
    emailOrHandleRequired: "Proporciona un correo o un identificador",
    emailInvalid: "Ingresa un correo electrónico válido",
    fieldRequired: "Este campo es obligatorio",
    passwordMismatch: "Las contraseñas no coinciden"
  },
  tips: {
    identifier: "Ingresa tu identificador (ej. @tuidentificador) o tu correo. Puedes escribir @ antes del identificador — se eliminará automáticamente.",
    loginPassword: "Tu contraseña. Usa \"¿Olvidaste la contraseña?\" si no la recuerdas.",
    displayName: "Tu nombre público — aparece en los créditos y tu perfil. Puede incluir espacios, emojis y Unicode.",
    accountName: "Tu identificador único — usado en URLs de perfil y @menciones. Solo minúsculas, números, _ y -. Se genera automáticamente desde tu nombre visible, pero puedes personalizarlo.",
    email: "Usado para inicio de sesión y recuperación de cuenta. Opcional si tienes identificador — pero muy recomendado.",
  ...
  errors: {
    ...
    accountName_taken: "Este identificador ya está en uso.",
    accountName_not_found: "No encontramos una cuenta con ese identificador.",
    accountName_invalid: "El identificador debe tener 3–30 caracteres: minúsculas, números, _ o -",
    accountName_change_cooldown: "Puedes cambiar tu identificador en {{days}} día(s).",
