export default {
  ...
  stats: {
    ...
    tips: {
      ...
      currentStreak: "Días consecutivos (UTC) en los que guardaste letras, creaste o bifurcaste un proyecto.",
      longestStreak: "Tu serie más larga de días consecutivos creando (UTC).",
  ...
  viewAsOthers: "Ver como otros",
  viewingAsOthers: "Estás viendo tu perfil como lo ven otros",
  exitViewAsOthers: "Salir",
  streakDays_one: "Racha de {{count}} día",
  streakDays_other: "Racha de {{count}} días",
  streakLongest_one: "Racha más larga: {{count}} día",
  streakLongest_other: "Racha más larga: {{count}} días",
  streakNone: "Sin racha activa",
  streakResetHint: "Los días se reinician a las 00:00 UTC ({{time}} en tu hora).",
  ...
  levelLabel: "Nv.",
  followsYou: "Te sigue",
  syncingActivity: "Sincronizando: {{song}}",
  friends: "Amigos",
  follow: "Seguir",
  ...
  noFriends: "Aún no hay amigos mutuos. Sigue a alguien que ya te siga.",
  ...
  settings: {
    ...
    onlineVisibility: "Mostrar estado en línea",
    onlineVisibilityDesc: "Quién puede ver tu estado en línea",
    ...
    lastOnlineVisibility: "Última conexión",
    lastOnlineVisibilityDesc: "Quién puede ver cuándo estuviste activo por última vez",
    countryVisibility: "Visibilidad del país",
    countryVisibilityDesc: "Quién puede ver tu país en tu perfil",
    visibilityEveryone: "Todos",
    visibilityFriends: "Amigos",
    visibilityNobody: "Nadie",
    defaultProjectPrivacy: "Privacidad predeterminada del proyecto",
    newProjectsVisibility: "Visibilidad de nuevos proyectos",
    newProjectsVisibilityDesc: "Establece el estado de privacidad por defecto al crear nuevos proyectos.",
    public: "Público",
    private: "Privado",
    ...
    lastLoginHour: "Hora del último inicio de sesión",
    showActivityHeatmap: "Mostrar mapa de actividad en mi perfil",
    showActivityHeatmapSub: "Desactivado por defecto: revela qué días estás activo",
    miniProfileBadges: "Mostrar insignias en el perfil rápido",
    miniProfileBadgesSub: "Muestra hasta 3 insignias al pasar el cursor sobre tu nombre",
    miniProfileBadgesPick: "Seleccionar insignias",
    noBadges: "Aún no tienes ninguna insignia.",
  },
  notifications: 'Preferencias de notificaciones',
  notif_follow: 'Notificaciones de seguimiento',
  notif_reaction: 'Notificaciones de reacciones',
  notif_star: 'Notificaciones de estrellas',
  notif_fork: 'Notificaciones de bifurcaciones',
  notif_badge_awarded: 'Notificaciones de insignias',
  notif_xp_changed: 'Notificaciones de XP',
  notif_streak_warning: 'Recordatorios de racha a punto de terminar',
