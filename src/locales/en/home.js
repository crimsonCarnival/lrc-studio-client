export default {
  ...
  projectProgress: "{{total}} projects. One is {{remaining}} lines away from completion.",
  resume: "Resume",
  ...
  startAnotherDesc: "Paste a YouTube link or upload an audio and we'll take you to the editor.",
  search: "Search...",
  sortBy: "Sort by",
