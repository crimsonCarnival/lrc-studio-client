export default {
  ...
  stats: {
    ...
    tips: {
      ...
      currentStreak: "Consecutive days (UTC) on which you saved lyrics, created or forked a project.",
      longestStreak: "Your longest ever run of consecutive authoring days (UTC).",
  ...
  viewingAsOthers: "Viewing your profile as others see it",
  exitViewAsOthers: "Exit",
  streakDays_one: "{{count}}-day streak",
  streakDays_other: "{{count}}-day streak",
  streakLongest_one: "Longest streak: {{count}} day",
  streakLongest_other: "Longest streak: {{count}} days",
  streakNone: "No active streak",
  streakResetHint: "Days reset at 00:00 UTC ({{time}} your time).",
  ...
  noFriends: "No mutual follows yet. Follow someone who follows you back.",
  ...
  settings: {
    ...
    onlineVisibility: "Show online status",
    onlineVisibilityDesc: "Who can see your live online status",
    ...
    lastOnlineVisibility: "Last Online",
    lastOnlineVisibilityDesc: "Who can see when you were last active",
    countryVisibility: "Country Visibility",
    countryVisibilityDesc: "Who can see your country on your profile",
    visibilityEveryone: "Everyone",
    visibilityFriends: "Friends",
    visibilityNobody: "Nobody",
    defaultProjectPrivacy: "Default Project Privacy",
    newProjectsVisibility: "New Projects Visibility",
    newProjectsVisibilityDesc: "Sets the default privacy state when creating new projects.",
    public: "Public",
    private: "Private",
    ...
    showActivityHeatmap: "Show activity heatmap on my profile",
    showActivityHeatmapSub: "Off by default: it reveals which days you are active",
    miniProfileBadges: "Show badges in mini profile",
    miniProfileBadgesSub: "Display up to 3 selected badges when hovering your name",
    miniProfileBadgesPick: "Select badges",
    noBadges: "You don't own any badges yet.",
  },
  notifications: 'Notification preferences',
  notif_follow: 'Follow notifications',
  notif_reaction: 'Reaction notifications',
  notif_star: 'Star notifications',
  notif_fork: 'Fork notifications',
  notif_badge_awarded: 'Badge award notifications',
  notif_xp_changed: 'XP update notifications',
  notif_streak_warning: 'Streak ending reminders',
