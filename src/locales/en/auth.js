export default {
  ...
  loginSubtitle: "Enter your handle or email to continue.",
  ...
  signOut: "Sign out",
  username: "Username",
  accountName: "Handle (optional)",
  displayName: "Display name",
  handleOrEmail: "Handle or email",
  accountNameHint: "Used for URLs and mentions. Lowercase, 3–30 chars.",
  accountNamePlaceholder: "handle (optional)",
  email: "Email",
  password: "Password",
  ...
  validation: {
    ...
    accountNamePattern: "Handle must be 3–30 characters: lowercase letters, numbers, _ or -",
    identifierInvalid: "Enter a valid email or handle (e.g. @yourhandle)",
    emailOrHandleRequired: "Provide an email or a handle",
    emailInvalid: "Please enter a valid email address",
    fieldRequired: "This field is required",
    passwordMismatch: "Passwords do not match"
  },
  tips: {
    identifier: "Enter your handle (e.g. @yourhandle) or your email address. You can type @ before the handle — it will be stripped automatically.",
    loginPassword: "Your account password. Use \"Forgot password?\" if you can't remember it.",
    displayName: "Your public name — shown in credits and on your profile. Can include spaces, emojis, and Unicode.",
    accountName: "Your unique handle — used in profile URLs and @mentions. Lowercase letters, numbers, _ and - only. Auto-generated from your display name, but you can customize it.",
    email: "Used for sign-in and account recovery. Optional if you set a handle — but strongly recommended.",
  ...
  errors: {
    ...
    accountName_taken: "This handle is already taken.",
    accountName_not_found: "We couldn't find an account with that handle.",
    accountName_invalid: "Handle must be 3–30 characters: lowercase letters, numbers, _ or -",
    accountName_change_cooldown: "You can change your handle in {{days}} day(s).",
