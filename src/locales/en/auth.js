export default {
  ...
  spotifyContinue: "Continue with Spotify",
  ...
  passkeyManagement: {
    ...
    passkeyLabel: "Passkey #{{number}}",
    platformLabel: "Platform Authenticator",
    usbKeyLabel: "USB Security Key",
    phoneLabel: "Phone / Cross-Device",
    added: "Added: {{date}}",
